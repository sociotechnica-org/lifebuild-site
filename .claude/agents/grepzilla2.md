...
This is an **Astro 5.x static site** that publishes _The Sovereignty Gap_ (a nonfiction book) along with a landing page, changelog, and editorial tooling. The stack:
