...
The chapter does six things:

1. **Establishes the author's credibility through the texture of the work, not declaration.** The reader watches someone navigate genuinely complex problems. Competence is shown, never claimed.

2. **Delivers the dishrag moment as the book's inciting incident.** The scene the whole book hangs from.
...
6. **Lands the stable ground argument as a load-bearing strategic claim.** Not a lifestyle preference. A strategic principle anchored in both the Jevons paradox (work failed) and the 2020 inversion (home worked, once, by accident).
...
4. **Lands the first promotion metaphor as action, not concept.** Ch 1 introduced it. Ch 2 operationalized it. This chapter delivers the experience of directing -- making an executive decision about your own life.
...
Frame through the promotion metaphor: this is the reader's first executive decision about their own life. Not a productivity hack. Not a morning routine adjustment. A director-level decision about what stays and what goes.
...
**Reader knows at entry:** The directive (72 hours, first act as director), the constraint. Does NOT yet have the thorn metaphor.
...
**State changes to narrate:** The author's specific thorn story -- a new narrative following the method the reader is about to attempt. The relief is narrated physically and specifically. The director frame is applied to the experience.
...
**Kill list for this beat:** "They don't require special tools -- just clarity, courage, willingness." Extended completion psychology. Sovereignty language. Marcus. "The micro-skills of sovereignty" (becomes "the micro-skills of directing" or no label). Four gaps/bridges references.
...
But name what changed: "You have data now. The thorn cost you something. Pulling it cost you something. Was it worth it? That's not a motivational question. It's a director's question."
...
**State changes to narrate:** The honest assessment of scope. The cost reframe (recurring drain -> one-time investment = director's ROI). The pivot from first win to full structure. Part III previewed.
...
- "The micro-skills of sovereignty" (becomes "the micro-skills of directing" or no label)
